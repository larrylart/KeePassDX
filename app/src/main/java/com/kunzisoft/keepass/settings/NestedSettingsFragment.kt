...
abstract class NestedSettingsFragment : PreferenceFragmentCompat() {
    ...
    enum class Screen {
        APPLICATION, FORM_FILLING, DEVICE_UNLOCK, APPEARANCE, OUTPUT_PROVIDER, DATABASE, DATABASE_SECURITY, DATABASE_MASTER_KEY
    }
    ...
    companion object {
        ...
        fun newInstance(key: Screen)
            ...
            val fragment: NestedSettingsFragment = when (key) {
				...
				Screen.OUTPUT_PROVIDER -> OutputProviderPreferenceFragment()	// larry
                Screen.DATABASE,
        ...
        fun retrieveTitle(resources: Resources, key: Screen): String {
            return when (key) {
				...
				Screen.OUTPUT_PROVIDER -> resources.getString(R.string.menu_output_provider_settings)
