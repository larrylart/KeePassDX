...
class OutputProviderRowPreference @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : Preference(context, attrs) {

    init { layoutResource = R.layout.pref_output_provider_row }
    ...
    var onProviderSelected: ((address: String, label: String) -> Unit)? = null

    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        super.onBindViewHolder(holder)
        dropdown = holder.findViewById(R.id.outputProviderDropdown) as MaterialAutoCompleteTextView
        ...
        dropdown?.apply {
            ...
            setOnItemClickListener { _, _, position, _ ->
                ...
                onProviderSelected?.invoke(addr, label)
            }
        }
    }
